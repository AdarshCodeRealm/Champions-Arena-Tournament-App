...
import { ScrollView, FlatList, TouchableOpacity, Image, Text, View, Dimensions } from 'react-native';
...
import { globalStyles, gameStyles, sponsorStyles } from '../../styles/globalStyles';
...
const CAROUSEL_IMAGES = [
  { id: '1', image: 'https://via.placeholder.com/350x200?text=Free+Fire+Action' },
  { id: '2', image: 'https://via.placeholder.com/350x200?text=Free+Fire+Characters' },
  { id: '3', image: 'https://via.placeholder.com/350x200?text=Free+Fire+Weapons' },
  { id: '4', image: 'https://via.placeholder.com/350x200?text=Free+Fire+Tournaments' },
  { id: '5', image: 'https://via.placeholder.com/350x200?text=Free+Fire+Gameplay' },
];
...
const NEWS_ITEMS = [
  {
    ...
    summary: 'The biggest Free Fire tournament of the year with a prize pool of $2,000,000',
          ...
          <FlatList
            ...
            onMomentumScrollEnd={(event) => {
              const slideIndex = Math.floor(
                (event.nativeEvent.contentOffset.x + (carouselItemWidth / 2)) / carouselItemWidth
              );
            ...
            {CAROUSEL_IMAGES.map((_, index) => (
              ...
              >
                <View style={{
                  ...
                  borderRadius: 4,
                  marginHorizontal: 4,
                  backgroundColor: activeSlide === index ? '#FF4500' : '#D3D3D3'
                }} />
              </TouchableOpacity>
            ))}
          </View>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={sponsorStyles.sponsorCard}>
              <Image source={{ uri: item.logo }} style={sponsorStyles.sponsorLogo} />
